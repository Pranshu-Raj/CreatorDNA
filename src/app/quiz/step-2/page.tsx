    ...
    <div className="min-h-screen nature-bg">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="gamified-card p-6 bg-gradient-to-r from-teal-500 to-cyan-500 text-white">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <span className="text-4xl cute-illustration">🎨</span>
              <h1 className="text-2xl sm:text-3xl font-bold">Step 2: Skills & Interests</h1>
            </div>
            <p className="text-teal-100 text-sm sm:text-base">
              Share your hobbies, talents, and cultural background
            </p>
          </div>
        </div>
        ...
        {/* Step Overview */}
        <div className="mt-12">
          <div className="gamified-card p-6 bg-gradient-to-br from-teal-50 to-cyan-50">
